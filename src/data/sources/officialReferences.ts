...
export const officialReferences: OfficialReference[] = [
  ...
  {
    id: 'cambridge-9705-published-resources',
    publisher: 'Cambridge International Education',
    sourceName: 'Cambridge International AS & A Level Design & Technology 9705 published resources',
    sourceUrl: 'https://www.cambridgeinternational.org/programmes-and-qualifications/cambridge-international-as-and-a-level-design-and-technology-9705/published-resources/',
    attributionNote: 'Original website-ready summary created from official Cambridge public qualification information. Do not reproduce official web pages directly.',
    copyrightUse: 'summary-only',
    notes: 'Reference for checking whether Cambridge lists endorsed or published resources for 9705.',
  },
  {
  ...
  {
    id: 'cambridge-0445-official-page',
    publisher: 'Cambridge International Education',
    sourceName: 'Cambridge IGCSE Design & Technology 0445 official qualification page',
    sourceUrl: 'https://www.cambridgeinternational.org/programmes-and-qualifications/cambridge-igcse-design-and-technology-0445/',
    attributionNote: 'Original website-ready summary created for this platform from official Cambridge qualification information and supplied syllabus structures. Do not reproduce official syllabus pages directly.',
    copyrightUse: 'summary-only',
    notes: 'Official public reference for Cambridge IGCSE Design & Technology 0445, including syllabus-cycle links, specimen materials and updates.',
  },
  {
    id: 'cambridge-0445-published-resources',
    publisher: 'Cambridge International Education',
    sourceName: 'Cambridge IGCSE Design & Technology 0445 published resources',
    sourceUrl: 'https://www.cambridgeinternational.org/programmes-and-qualifications/cambridge-igcse-design-and-technology-0445/published-resources/',
    attributionNote: 'Original website-ready summary created from official Cambridge public qualification information. Do not reproduce official web pages directly.',
    copyrightUse: 'summary-only',
    notes: 'Reference for Cambridge listed 0445 published resources, including the Collins 2026 Student’s Book for the refreshed syllabus.',
  },
  {
    id: 'cambridge-0445-2024-2026',
    publisher: 'Cambridge International Education',
    sourceName: 'Cambridge IGCSE Design & Technology 0445 syllabus 2024-2026',
    sourceUrl: 'local:/Users/cmok/Downloads/635750-2024-2026-syllabus.pdf',
    attributionNote: 'Original website-ready summary created for this platform from the supplied syllabus structure. Do not reproduce official syllabus pages directly.',
    copyrightUse: 'summary-only',
    notes: 'Reference for the current Cambridge IGCSE 0445 content and assessment structure before the refreshed 2028 cycle.',
  },
  {
    id: 'cambridge-0445-2028-2030',
    publisher: 'Cambridge International Education',
    sourceName: 'Cambridge IGCSE Design & Technology 0445 syllabus 2028-2030',
    sourceUrl: 'local:/Users/cmok/Downloads/743280-2028-2030-syllabus.pdf',
    attributionNote: 'Original website-ready summary created for this platform from the supplied syllabus structure. Do not reproduce official syllabus pages directly.',
    copyrightUse: 'summary-only',
    notes: 'Reference for refreshed 0445 common content, Component 2 marking, Paper 3 Materials and Paper 4 Graphic Products updates.',
  },
  {
